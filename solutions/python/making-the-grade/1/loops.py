...
def count_failed_students(student_scores=list)->int:
    ...
    failures = len([score for score in student_scores if score <= 40]) #2nd iteration
    
    # 3rd iteration    failures = sum(1 for score in student_scores if score <= 40) 
...
def above_threshold(student_scores=list, threshold=int)->list:
    ...
    # best = [score for score in student_scores if score >= threshold]
